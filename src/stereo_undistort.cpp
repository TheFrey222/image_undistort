...
StereoUndistort::StereoUndistort(const ros::NodeHandle& nh,
  ...
  first_camera_info_output_pub_ = nh_.advertise<sensor_msgs::CameraInfo>(
      "camera/left/camera_info", queue_size_);
  second_camera_info_output_pub_ = nh_.advertise<sensor_msgs::CameraInfo>(
      "camera/right/camera_info", queue_size_);
  first_image_pub_ = it_.advertise("camera/left/image_raw", queue_size_);
  second_image_pub_ = it_.advertise("camera/right/image_raw", queue_size_);
